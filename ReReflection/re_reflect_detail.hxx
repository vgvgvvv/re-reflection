...
public:
    re_reflect::Type const *m_type;
    unsigned m_flags;
    unsigned m_serializedWidth;
    unsigned m_offset;
    re_reflect::Qualifier m_qualifier;
    char const *m_name;
};
...
/* Primitives                                                                */
/* ========================================================================= */
#include "re_reflect_fundamental.hxx"
#include "re_reflect_templates.hxx"
