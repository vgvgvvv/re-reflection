...
struct PropertyAnnotations {
  PropertyAnnotations() : serialized(false), width(0) {}
...
inline raw_ostream &operator<<(raw_ostream &os, PropertyAnnotations::FlagPrinter const &p) {
  os << "Field::kFlagsNull";
...
inline raw_ostream &operator<<(raw_ostream &os, FunctionAnnotations::FlagPrinter const &p) {
